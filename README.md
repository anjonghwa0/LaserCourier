...
No requirement changes have been made after the `Laser Courier` proposal.

`requirements.md` and `LaserCourier_Requirements.pdf` are the authoritative requirements. The current implementation follows those requirements.
